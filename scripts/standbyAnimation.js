...
var canvasPieTimer = {
    ...
    fillColour :$("body").css("background-color"),
    bgColour : "white",

    init: function(canvasSize, canvasId, parentId){
        $("#canvaspietimer").remove();
        ...
        this.canvasInterval = setInterval(function(){if(!paused)canvasPieTimer.updatePie(); }, this.timeInterval);
    },
    ...
    ResumeDrawing: function(){
      var pietimerholderVar = document.getElementById("pietimerholder");
      var canvaspietimerVar = document.getElementById("canvaspietimer");
      var garbage = pietimerholderVar.removeChild(canvaspietimerVar); // This first call remove correctly the node
      Game.start();
    }
}
